...
def compute_consensus(pos_ssc, neg_ssc):
    ...
    # Set the CIGAR string (to prevent parsing errors generated by the consensus sequence)
    pos_ssc.cigarstring = f"{len(pos_ssc.query_sequence)}M"
...
with pysam.AlignmentFile(input_pos_bam, "rb") as pos_bam, pysam.AlignmentFile(input_neg_bam, "rb") as neg_bam:
    ...
    with pysam.AlignmentFile(dsc_output, "w", template=pos_bam) as dsc_bam:
